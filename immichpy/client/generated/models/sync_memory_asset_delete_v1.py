...
class SyncMemoryAssetDeleteV1(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SyncMemoryAssetDeleteV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SyncMemoryAssetDeleteV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {"assetId": obj.get("assetId"), "memoryId": obj.get("memoryId")}
        )
        return _obj
