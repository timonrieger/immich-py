...
class WorkflowActionResponseDto(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowActionResponseDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowActionResponseDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "id": obj.get("id"),
                "order": obj.get("order"),
                "pluginActionId": obj.get("pluginActionId"),
