...
- **Generation issues** (bad codegen output, typing problems introduced by generation, workflow automation problems): [open an issue on GitHub](https://github.com/timonrieger/immich-py/issues).
