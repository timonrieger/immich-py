...
class QueuesResponseLegacyDto(BaseModel):
    ...
    metadata_extraction: QueueResponseLegacyDto = Field(alias="metadataExtraction")
    ...
    smart_search: QueueResponseLegacyDto = Field(alias="smartSearch")
    storage_template_migration: QueueResponseLegacyDto = Field(
        alias="storageTemplateMigration"
    )
    thumbnail_generation: QueueResponseLegacyDto = Field(alias="thumbnailGeneration")
    video_conversion: QueueResponseLegacyDto = Field(alias="videoConversion")
