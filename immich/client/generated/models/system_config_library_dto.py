...
class SystemConfigLibraryDto(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "scan": SystemConfigLibraryScanDto.from_dict(obj["scan"])
                if obj.get("scan") is not None
                else None,
                "watch": SystemConfigLibraryWatchDto.from_dict(obj["watch"])
                if obj.get("watch") is not None
                else None,
            }
        )
        return _obj
