...
class ViewsApi:
    ...
    @validate_call
    async def get_assets_by_original_path(
        self,
        path: StrictStr,
    ...
    @validate_call
    async def get_assets_by_original_path_with_http_info(
        self,
        path: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_assets_by_original_path_without_preload_content(
        self,
        path: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def get_unique_original_paths(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_unique_original_paths_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def get_unique_original_paths_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
